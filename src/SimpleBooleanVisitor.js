...
export default class SimpleBooleanVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by SimpleBooleanParser#bool.
	visitBool(ctx) {
	  return this.visitChildren(ctx);
	}
