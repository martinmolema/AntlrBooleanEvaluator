...
export default class SimpleBooleanListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by SimpleBooleanParser#bool.
	enterBool(ctx) {
	}

	// Exit a parse tree produced by SimpleBooleanParser#bool.
	exitBool(ctx) {
	}
